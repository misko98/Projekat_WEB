...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vojska.Models.Bataljon", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Vojska.Models.Puk", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Vojska.Models.Vojska", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Vojska.Models.Bataljon", b =>
                {
                    b.HasOne("Vojska.Models.Puk", "Puk")
                        .WithMany("Bataljoni")
                        .HasForeignKey("PukID");
            ...
            modelBuilder.Entity("Vojska.Models.Puk", b =>
                {
                    b.HasOne("Vojska.Models.Vojska", "Vojska")
                        .WithMany("Pukovi")
